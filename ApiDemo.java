...
//	private final ContractInfoPanel m_contractInfoPanel = new ContractInfoPanel();
	public TradingPanel m_tradingPanel = new TradingPanel();
	public AccountInfoPanel m_acctInfoPanel = new AccountInfoPanel();
...
//	public final AutoTradePanel m_autoPanel1 = new AutoTradePanel(new AutoTradeBuilder("EUR/USD",SecType.CASH, 20000, 0.0001, 0.005)
//			.setDay("5").setBarSize(BarSize._15_mins));
	public final AutoTradePanel m_autoPanel2 = new AutoTradePanel(new AutoTradeBuilder("EUR/GDP", SecType.CASH, 20000, 0.0001, 0.005)
			.setDay("5").setBarSize(BarSize._15_mins));
//	public final AutoTradePanel m_autoPanel3 = new AutoTradePanel(new AutoTradeBuilder("AAPL", SecType.STK, 1, 0.5,0.5)
//			.setDay("5").setBarSize(BarSize._15_mins));
//	public final AutoTradePanel m_autoPanel4 = new AutoTradePanel(new AutoTradeBuilder("IBM", SecType.STK, 1, 0.5,0.5)
//			.setDay("5").setBarSize(BarSize._15_mins));
	public final AutoRobotPanel m_autoPanel5 = new AutoRobotPanel(new AutoTradeBuilder("EUR/USD",SecType.CASH, 20000, 0.0001, 0.005)
			.setDay("2").setBarSize(BarSize._15_mins));
	public final AutoRobotPanel m_autoPanel6 = new AutoRobotPanel(new AutoTradeBuilder("AAPL",SecType.STK, 1, 0.5, 0.5)
			.setDay("5").setBarSize(BarSize._5_mins));
//	public final AutoTradePanel m_autoPanel1 = new AutoTradePanel("EUR/USD","cash",20000,0.001,0.0005, "5", BarSize._15_mins);
//	public final AutoTradePanel m_autoPanel2 = new AutoTradePanel("EUR/GBP","cash",20000,0.001,0.0005,"5", BarSize._15_mins);
//	public final AutoTradePanel m_autoPanel3 = new AutoTradePanel("AAPL","stock",1,0.5,0.5,"15", BarSize._15_mins);
//	public final AutoTradePanel m_autoPanel4 = new AutoTradePanel("IBM","stock",1,0.5,0.5,"15", BarSize._15_mins);
	
	public final BackTestPanel m_backtest = new BackTestPanel("EUR/USD",SecType.CASH,1.0,0.5,0.5,"15", BarSize._1_day);
	private final JTextArea m_msg = new JTextArea();
	
	
	
	// global request
	// use when you need global request and realtime update ex Account, livePosition,  
	private void accountReady() {
		m_acctInfoPanel.activated();
		m_tradingPanel.m_ordersPanel.activated();
	}
...
//		m_tabbedPanel.addTab( "News", m_newsPanel);
		m_tabbedPanel.addTab("Backtest", m_backtest);

//		m_tabbedPanel.addTab("EUR/USD", m_autoPanel1);
		m_tabbedPanel.addTab("EUR/GBP", m_autoPanel2);
//		m_tabbedPanel.addTab("AAPL", m_autoPanel3);
//		m_tabbedPanel.addTab("IBM", m_autoPanel4);
		
		m_tabbedPanel.addTab("EUR/USD", m_autoPanel5);
		m_tabbedPanel.addTab("AAPL", m_autoPanel6);
		...
		// make initial connection to local host, port 7496, client id 0, no connection
		// options
		controller().connect("127.0.0.1", 7496, 0,
				m_connectionConfiguration.getDefaultConnectOptions() != null ? "" : null);
		
//		m_acctInfoPanel.setVisible(true);s s
