...
public class PositionsPanel extends NewTabPanel {
	...
	class PositionModel extends AbstractTableModel implements IPositionHandler {
...
//			System.out.println(contract.symbol()+" " +position+" "+m_model.getRowCount());
...
//			Map<PositionKey,PositionRow> m_map = new HashMap<>();
//			List<PositionRow> m_list = new ArrayList<>();
//			m_list = m_positionsPanel.getModel().m_list;
//			m_map = m_positionsPanel.getModel().m_map;
