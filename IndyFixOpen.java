...
public class IndyFixOpen extends ArrayList<Double> {
	
//	ArrayList<Double> fixPrice = new ArrayList<Double>();
	public IndyFixOpen(String period, ArrayList<Bar> bars) {
